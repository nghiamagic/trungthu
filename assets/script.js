...
const wishList = [
  {
    text: "Chúc Sếp Pé và gia đình một mùa Trung Thu đoàn viên, tràn ngập niềm vui và hạnh phúc!",
    img: "./assets/1.jpg",
  },
  {
    text: "Cầu chúc cho mọi nguyện ước của Sếp Pé đêm nay sẽ trở thành hiện thực.",
    img: "./assets/2.jpg",
  },
  {
    text: "Trăng tròn ấm áp, chúc Sếp Pé luôn nở mãi nụ cười trên môi.",
    img: "./assets/3.jpg",
  },
  {
    text: "Chúc Sếp Pé luôn giữ được tâm hồn trong trẻo, yêu đời như ánh trăng rằm.",
    img: "./assets/1.jpg",
  },
  {
  ...
  {
    text: "Chúc riêng Sếp Pé một đêm trăng thật lãng mạn và ngọt ngào.",
    img: "./assets/3.jpg",
  },
  {
